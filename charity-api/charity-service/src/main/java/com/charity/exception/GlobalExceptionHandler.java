...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({InvalidDataException.class, BoxAlreadyAssignedException.class,
            BoxNotEmptyException.class, IllegalCurrencyCodeException.class,
            InvalidRequestException.class, IllegalArgumentException.class,
            BoxNotAssignedException.class, EmptyBoxException.class})
